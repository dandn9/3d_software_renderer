...
face_t cube_faces[N_CUBE_FACES] = {
    ...
    // right
    {.a = 4, .b = 3, .c = 5, .color = 0xFFFFFFF0},
    {.a = 4, .b = 5, .c = 6, .color = 0xFFFFFFF0},
    // back
    {.a = 6, .b = 5, .c = 7, .color = 0xFFFF00FF},
    {.a = 6, .b = 7, .c = 8, .color = 0xFFFF00FF},
    // left
    {.a = 8, .b = 7, .c = 2, .color = 0xFFF00000},
    {.a = 8, .b = 2, .c = 1, .color = 0xFFF00000},
    // top
    {.a = 2, .b = 7, .c = 5, .color = 0xFF555500},
    {.a = 2, .b = 5, .c = 3, .color = 0xFF555500},
    // bottom
    {.a = 6, .b = 8, .c = 1, .color = 0xFF111111},
    {.a = 6, .b = 1, .c = 4, .color = 0xFF111111}};
